...
namespace java com.yahoo.omid.thrift.generated
...
struct TDelete {
  1: required binary row,
  2: optional list<TColumn> columns,
  3: optional TDeleteType deleteType = 1,
...
service TOmidService {

  TTransaction startTransaction() throws (1:TIOError io)

  bool commitTransaction(
    /** the transaction to be committed */
    1: required TTransaction transaction, 
  ) throws (1:TIOError io, 2:TCommitFailed abort)
  ...
  TResultExists exists(
    ...
    /** the transaction id */
    3: required TTransaction transaction,
